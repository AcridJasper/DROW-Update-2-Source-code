class KFExplosion_Healer6 extends KFExplosionActorLingering;
...
protected simulated function AffectsPawn(Pawn Victim, float DamageScale)
{
	...
	else
	{
		...
		KFP.ApplyDamageOverTime(class'KFDT_DoT_Toxic_Healer6'.default.PoisonPower, Instigator.Controller, class'KFDT_DoT_Toxic_Healer6');
	}
}
